...
PartPOneVoiceOne =  {
  ...
  \stemNeutral
  \mark #21 r4
  g''16\harmonic\startTextSpan ^\markup{\bold\large { spiccato }} _"G4" 
  ...
  a'''16\harmonic [ e''''16\harmonic a'''16\harmonic d'''16\harmonic ]
  g''16\harmonic [ d'''16\harmonic a'''16\harmonic e''''16\harmonic ]
  a'''16\harmonic [ d'''16\harmonic g''16\harmonic d'''16\harmonic ] \stopTextSpan | % 58
  r2. | % 59
  ...
  a'2.:32^~ | % 79
  a'2.:32\glissando | \barNumberCheck #80
  b'2.:32\glissando | % 81
  c''2.:32 | % 82
...
PartPTwoVoiceOne =  {
  ...
  \override TextSpanner.bound-details.left.text = "Flautando"
  \stemUp
  d2.:32^~\startTextSpan \ppp | % 19
  d2.:32^~  | \barNumberCheck #20
  d2.:32^~  | % 21
  d2.:32^~  | % 22
  d2.:32^~  | % 23
  ...
  \override TextSpanner.bound-details.left.text = "Sul Pont."
  \clef "treble"
  \ottava #1 c''16\harmonic\startTextSpan ^\markup {\bold\large { spiccato }} 
  ...
  e'''16\harmonic  a''16\harmonic d''16\harmonic a''16\harmonic ] \stopTextSpan  \ottava #0 | % 64
  \clef "bass"
  r2. | % 65
  \stemDown
  g2.\p | % 66
  ...
  a2.^~ | % 82
  a2.:32^~ | % 83
  a2.:32\stopTextSpan  | % 84
  r2. | % 85
  a2.:32^~ | % 86
  a2.:32^~ | % 87
  a2.:32^~ | % 88
  a2.:32^~ | % 89
  a2:32 r4 | \barNumberCheck #90
  a2.:32 | % 91
  s2. \bar "|."
}
...
PartPTwoVoiceTwo =  {
  ...
  R2.*5 | % 18
  d2.:32_~ | % 19
  d2.:32\glissando | \barNumberCheck #20
  c2.:32_~ | % 21
  c2.:32_~ | % 22
  c2.:32_~ | % 23
  c2:32 s4 | % 24
