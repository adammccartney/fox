...
PartPOneVoiceOne =  {
 ...
 \override TextSpanner.bound-details.left.text = "Sul Pont."
  ...
  \mark #8 g'8\harmonic \ppp ^"G2"^\markup{\bold\large{ Spiccato Sempre }} [ d''8\harmonic^"D2" a''8\harmonic^"A2" e'''8\harmonic^"E2" ] 
  ...
  a'''8\harmonic [ e''''8\harmonic a'''8\harmonic d'''\harmonic ]
  g''8\harmonic [ d'''8\harmonic a'''8\harmonic e''''8\harmonic ]
  a'''8\harmonic [ d'''8\harmonic g''8\harmonic d'''8 \harmonic ] \stopTextSpan \glissandoSkipOn
  ...
  % C 1 / 5
  \override TextSpanner.bound-details.left.text = "Ord."
  \mark #12 g'8\harmonic _"G2"\startTextSpan [ d''8\harmonic _"D2" a''8\harmonic _"A2" e'''8\harmonic _"E2" ] 
  a''8\harmonic [ d''8\harmonic g'8\harmonic d''8 \harmonic ]
  a''8\harmonic [ e'''8\harmonic a''8\harmonic d''\harmonic ]
  g'8\harmonic [ d''8\harmonic a''8\harmonic e'''8\harmonic ]
  a''8\harmonic [ d''8\harmonic g'8\harmonic d''8 \harmonic ] \glissandoSkipOn
  ...
  %4/5
  \glissandoSkipOff
  d''8\harmonic _"G3" [ a''8\harmonic _"D3" e'''8\harmonic _"A3" b'''8\harmonic _"E3" ] 
...
PartPTwoVoiceOne =  {
  ...
  d8 [ d'8 d8 c8 ]
  \glissandoSkipOff c,8 [ cih8 d8 dih'8 ]\stopTextSpan
  \override TextSpanner.bound-details.left.text = "Sul Pont."
  ...
  c,8 [ cih8 d8 dih'8 ]
  d8 [ cih8 c,8 cih8 ]
  \glissandoSkipOff r4 <cih d>4\stopTextSpan \sfp
  r2
  % 5 / 5
  \override TextSpanner.bound-details.left.text = "Flautando"
  c,8\startTextSpan [ cih8 d8 dih'8 ] \glissandoSkipOn
  d8 [ cih8 c,8 cih8 ]
  d8 [ \glissandoSkipOff d'8 d8 c8 ]
  c,8 [ c8 d8 d'8 ]
  ...
  a8 [ a8 a8 g,8 ]
  g,8 [ g,8 a8 a8 ]
  a8 [ g,8 g,8 g,8 ] \glissandoSkipOn
  % 2 / 5
  a8 [ a8 a8 g,8 ]
  g,8 [ g,8 a8 a8 ]
  \glissandoSkipOff a8\stopTextSpan [ g,8 fih,8 g,8 ]
  \override TextSpanner.bound-details.left.text = "Flautando"
  ...
  r2
  fih,8 [ g,8 fih8 a8 ]
  fih8 [ g,8 fih,8 g,8 ] \glissandoSkipOn
  % 4 / 5
  fih8 [ a8 fih8 g,8 ]
  fih,8 [ g,8 fih8 a8 ]
  \glissandoSkipOff gih8\stopTextSpan [ g,8 gih,8 g,8 ]
  \override TextSpanner.bound-details.left.text = "Ord."
  r4 <gih a>4\startTextSpan \sfp
  r2
  % 5 / 5
  a8 [ gih8 g,8 gih,8 ] \glissandoSkipOn
  g,8 [ gih,8 gih8 a8 ]
  gih8 [ \glissandoSkipOff g,8 g,8 g,8 ]
  a8 [ a8 a8 g,8 ]
  ...
  % D 1 / 5
  \override TextSpanner.bound-details.left.text = "Ord."
  c,8 -"IV"\startTextSpan [ c8 -"III" d8 -"II" d'8 -"I" ]
  d8 [ c8 c,8 c8 ]
  d8 [ d'8 d8 c8 ]
  c,8 [ c8 d8 d'8 ]
  d8 [ c8 c,8 c8 ]
  ...
  c,8 [ fih8 d8 gih'8 ]
  d8 [ fih8 c,8 fih8 ]
  \glissandoSkipOff r4 <dih d>4 \sfp
  r2
  % 5 / 5
  c,8 [ dih8 d8 eih'8 ] \glissandoSkipOn
  d8 [ dih8 c,8 dih8 ]
  \glissandoSkipOff d8 [ d'8 d8 c8 ] \stopTextSpan
  \override TextSpanner.bound-details.left.text = "Flautando"
