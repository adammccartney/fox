...
PartPOneVoiceOne =  {
  ...
  \tempo 4=60 f'2.:32 ^\markup {\column { \bold {pont.} glissando}} \pp \glissando \glissandoSkipOn f'2:32  | % 2
  \glissandoSkipOff fis'2. \p \glissando \glissandoSkipOn g'2:32 \pp | % 3
  ...
  \tuplet 3/2 {r8 g'4\harmonic \sfpp ~ } g'4\harmonic \sfpp ~ | % 43
...
PartPTwoVoiceTwo =  {
  ...
  d''''8-.\harmonic^"A11" [ ( d''''8-.\harmonic d''''8-.\harmonic d''''8-.\harmonic d''''8-.\harmonic d''''8-.\harmonic ) ]
...
PartPThreeVoiceThree =  {
  ...
  <bes, bes c'>2. ~ ~ ~| % 44
  <bes, bes c'>2. ~ ~ ~ <bes, bes c' d'>2 | % 45
  r4*5\fermata | % 46
  \break
  \makeClusters <f'' f'''>2\sustainOn _\markup { Glissando between broken clusters } 
